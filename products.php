...
echo $_SESSION['user'];?></strong></span><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="products.php" class="w3-bar-item w3-button w3-padding active"><i class="fa fa-database fa-fw"></i> View Products</a>
  ...
  <div class="w3-main " style="margin-left:300px;margin-top:60px;">
    ...
    <h1 class="w3-panel">Available Items</h1>
      <?php

      $sql = "SELECT productName,barCode,price,quantity,supplierName FROM products";
      $result = $con->query($sql);

      if ($result->num_rows > 0) {
        echo "<table class='w3-table-all w3-card-4'><tr  class='w3-blue'><th>Product Name</th><th>Bar Code</th><th>Price</th><th>Quantity</th><th>Supplier Name</th></tr>";
        // output data of each row
        while ($row = $result->fetch_assoc()) {
          echo "<tr><td>" . $row["productName"] . "</td><td>" . $row["barCode"] . "</td><td>" . $row["price"] . "</td><td>" . $row["quantity"] . "</td><td>" . $row["supplierName"] . "</td></tr>";
        }
        echo "</table>";
      } else {
        echo "0 results";
